...
cred = Credentials()
USER = cred.abe_mysql_user()
PASSWORD = cred.abe_mysql_pass()

engine = create_engine('mysql://'+USER+':'+PASSWORD+'@127.0.0.1/abe',echo = True,encoding='utf8', convert_unicode=True)
""""
...
class Queries():
    ...
    def count_rows(self,table):
        ...
        print('The total number of rows is:',rows_number)
    ...
    def in_chunks(self, percentage):
        """
        Returns a rounded up integer of a given percentage of
        the total rows in a query. The rounded up intger is
        used to query a table in chunks.
        """
        rows_number = self.__total_rows
    ...
    def set_results_offset(self, filename):
        """
        Selects a specific range of query results by reading the tracker file
        to establish the ending position of the last query
        """
    ...
    def create_new_dict(self,offset):
        ...
        #offset_to = self.set_results_offset(filename='/txout_detail')
    ...
    def test(self):
        ...
        print(self.__rows_percent,'From test:')
    ...
    def main(self):
        ...
        total_rows = self.count_rows(Txout_Detail)#1
        self.set_rows(total_rows)#2
        ...
        for x in range(floor_div[0]):
            ...
            #"""
            offset = self.set_results_offset(filename='/txout_detail')
